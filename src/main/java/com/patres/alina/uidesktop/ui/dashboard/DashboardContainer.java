...
public class DashboardContainer extends VBox {
    ...
    public DashboardContainer(MediaControlWidget mediaControlWidget, DashboardPane dashboardPane, GitHubWidget gitHubWidget) {
        ...
        widgetsBox.getChildren().addAll(mediaControlWidget, dashboardPane, gitHubWidget);
    ...
    private void refreshVisibility() {
        Platform.runLater(() -> {
            final boolean show = BackendApi.getWorkspaceSettings().showDashboard();
            setManaged(show);
            setVisible(show);
        });
    }

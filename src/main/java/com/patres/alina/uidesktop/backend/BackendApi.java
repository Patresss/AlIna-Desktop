...
public class BackendApi {
    ...
    public static AgentRuntimeStatus getAgentRuntimeStatus() {
        return AppLauncher.getBean(WorkspaceController.class).getAgentRuntimeStatus();
    }

    public static void prepareAgentForFreshChat() {

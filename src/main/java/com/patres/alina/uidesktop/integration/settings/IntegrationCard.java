...
import com.patres.alina.uidesktop.command.settings.CommandEditPane;
...
public class IntegrationCard extends CardItem {
    ...
    protected ApplicationModalPaneContent createEditPane() {
        final IntegrationDetails integration = null; //getAlinaRestClient().getIntegrationById(cardListItem.id());

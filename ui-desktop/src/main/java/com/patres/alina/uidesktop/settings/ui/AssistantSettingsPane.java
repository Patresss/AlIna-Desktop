...
public class AssistantSettingsPane extends SettingsModalPaneContent {
    ...
    protected void reset() {
        ...
        List<String> chatModels = AlinaRestApi.getAlinaRestClient().getChatModels();
    ...
    protected void save() {
        ...
        AlinaRestApi.getAlinaRestClient().updateAssistantSettings(assistantSettings);
    }

    private void loadDataFromSettings() {
        settings = AlinaRestApi.getAlinaRestClient().getAssistantSettings();
    }

...
import com.patres.alina.uidesktop.plugin.settings.PluginCreatePane;
...
public class IntegrationPane extends CardsPane {
    ...
    public ButtonBase createButton() {
        final List<IntegrationToAdd> availableIntegrationToAdd = AlinaRestApi.getAlinaRestClient().getAvailableIntegrationToAdd();
    ...
    public List<IntegrationCard> createCards() {
        final var integrationListItems = AlinaRestApi.getAlinaRestClient().getIntegrationListItem();

...
public enum HighlightJSTheme {
    ...
    public String getStylesCss() {
        return """
                body {
                    background-color: var(--alina-background-color);
                    color: var(--alina-color);
                    font-family: #fontFamily;
                    font-size: #fontSize;
                }"""
                .replaceAll("#fontFamily", DEFAULT_FONT_FAMILY_NAME)
                .replaceAll("#fontSize", DEFAULT_FONT_SIZE + "px");
    }

    public String getRootCss() {
        return """
                :root {
                    --alina-background-color: #backgroundColor;
                    --alina-color: #color;
                }"""
                .replaceAll("#backgroundColor", background)
                .replaceAll("#color", foreground);
    }

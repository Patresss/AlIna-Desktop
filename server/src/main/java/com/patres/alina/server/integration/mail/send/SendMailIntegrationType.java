...
import com.patres.alina.server.integration.homeassistant.HomeAssistantExecutor;
import com.patres.alina.server.integration.homeassistant.HomeAssistantIntegrationSettings;
...
@Component
public class SendMailIntegrationType extends AlinaIntegrationType<SendMailIntegrationSettings, SendMailExecutor> {

    private static final String INTEGRATION_TYPE_NAME = "sendEmail";
    private static final String INTEGRATION_DEFAULT_NAME_TO_DISPLAY = "Send email";
    private static final String INTEGRATION_DESCRIPTION = """
            Send an email""";
    private static final String ICON = "mdmz-mail";
    ...
    private static final UiForm UI_FORM = new UiForm(List.of(
            ...
            new FormField(HOST, INTEGRATION_TYPE_NAME + "host.name", "Host", INTEGRATION_TYPE_NAME + "host.description", "E.g. smtp.gmail.com", true, FormFieldType.TEXT_FIELD),
            new FormField(PORT, INTEGRATION_TYPE_NAME + "port.name", "Port", INTEGRATION_TYPE_NAME + "port.description", "E.g. 587", true, FormFieldType.TEXT_FIELD)
    ));


    public SendMailIntegrationType() {
    ...
    public SendMailIntegrationSettings createSettings(Integration integration) {
        return new SendMailIntegrationSettings(integration);
    }
}
